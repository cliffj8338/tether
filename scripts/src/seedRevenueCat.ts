...
const PROJECT_NAME = "Tether";

const PRODUCT_IDENTIFIER = "tether_family_monthly";
const PLAY_STORE_PRODUCT_IDENTIFIER = "tether_family_monthly:monthly";

const PRODUCT_DISPLAY_NAME = "Tether Family Monthly";
const PRODUCT_USER_FACING_TITLE = "Tether Family Monthly";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "Tether iOS";
const APP_STORE_BUNDLE_ID = "app.tetherapp.ios";
const PLAY_STORE_APP_NAME = "Tether Android";
const PLAY_STORE_PACKAGE_NAME = "app.tetherapp.android";

const ENTITLEMENT_IDENTIFIER = "premium";
const ENTITLEMENT_DISPLAY_NAME = "Premium Family Access";
